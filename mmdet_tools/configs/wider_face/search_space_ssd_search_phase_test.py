_base_ = [
    '../_base_/models/search_space_ssd.py', '../_base_/datasets/wider_face_od_api.py',
...
# Small dataset version for fast debugging
...
data = dict(
    ...
    val=dict(pipeline=test_pipeline, ann_file=data_root + 'new_annotation_val_coco_small.json'),
    test=dict(pipeline=test_pipeline, ann_file=data_root + 'new_annotation_val_coco_small.json'))
# optimizer
