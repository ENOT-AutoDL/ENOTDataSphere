_base_ = [
    '../_base_/models/search_space_ssd_masks.py', '../_base_/datasets/mask_face_pretrain.py',
...
data_root = '/home/jupyter/work/resources/mmdetection_expasoft/data/masks/'
classes = ('face', 'mask')

model = dict(
    bbox_head=dict(num_classes=num_classes, anchor_generator=dict(input_size=input_size))
)
lr_config = dict(
