...
from enot_utils import prepare_log
...
from enot_utils.distributed_utils import torch_save
from enot_utils.schedulers import Scheduler
from enot_utils.train_utils import init_exp_dir
...
def enot_pretrain(
    ...
    distributed_sampler = dist.is_initialized()
